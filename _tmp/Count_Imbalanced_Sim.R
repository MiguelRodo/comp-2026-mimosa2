...
rng_list = list(
  ".90_Count"   = c(rep(150000,6),rep(0.9*150000,2)),
  ".75_Count"   = c(rep(150000,6),rep(0.75*150000,2)),
  ".50_Count"   = c(rep(150000,6),rep(0.5*150000,2)),
  ".25_Count"   = c(rep(150000,6),rep(0.25*150000,2)),
  ".10_Count"   = c(rep(150000,6),rep(0.1*150000,2))
)
